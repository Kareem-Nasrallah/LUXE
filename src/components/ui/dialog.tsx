...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left mt-2", className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("absolute start-4 top-4 text-lg font-semibold leading-none tracking-tight", className)}
    {...props}
  />
));

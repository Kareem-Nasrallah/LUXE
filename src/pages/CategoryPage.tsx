...
const CategoryPage = () => {
  ...
  const { filteredItems: products, loading } = useAppSelector(
  ...
  return (
    <>
      <Helmet>
        <title>{category?.title || "Category"} - LUXE</title>
        <meta
          name="description"
          content={`Shop ${category?.title} products at LUXE.`}
        />
      </Helmet>
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-background/80">{products.length} products</p>
            </motion.div>
          </div>
        </div>

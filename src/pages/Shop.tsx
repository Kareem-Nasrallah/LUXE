      ...
      <div>
        ...
        <div className="space-y-2">
          <div className="flex items-center">
            ...
            />
            <Label htmlFor="all-categories" className="ms-2 cursor-pointer">
          ...
          {categories.map((cat) => (
            <div key={cat._id} className="flex items-center">
              <Checkbox
                id={cat._id}
                checked={filters.category === cat.slug.current}
                onCheckedChange={() => {
                  dispatch(setCategory(cat.slug.current));
                }}
              />
              <Label htmlFor={cat._id} className="ms-2 cursor-pointer">
                {cat.title}
              </Label>
            </div>
          ))}
        ...
        <div className="flex items-center">
          <Checkbox
            ...
            onCheckedChange={(checked) =>
              dispatch(setOnSale(checked as boolean))
            }
          />
          <Label htmlFor="on-sale" className="ms-2 cursor-pointer">
            {t("common.sale_only")}
          </Label>
        </div>
      </div>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Browse our complete collection of premium products. Find electronics, fashion, home goods, and more."
        />
      </Helmet>
